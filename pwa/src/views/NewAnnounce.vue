                            ...
                            <div class="md:grid md:grid-cols-4 md:gap-3">
                                <div class="md:col-span-1">
                                    <div class="px-4 sm:px-0">
                                        <br>
                                        <h3 class="text-lg font-medium leading-6 text-gray-900">Les information de
                                            l'announce </h3>
                                        <p class="mt-1 text-sm text-gray-600">Votre annonce ne sera pas publiée tant que
                                            l'administrateur n'aura pas validé votre demande.</p>
                                    </div>
                                </div>
