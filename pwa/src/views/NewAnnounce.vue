       ...
       <Header />
        ...
        <main>
            ...
            <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                ...
                <!-- Page header -->
                <div class="mb-8">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Ajouter une announce ✨</h1>
                </div>
                    ...
                    <div>
                        ...
                        <div class="md:col-span-1">
                            <div class="px-4 sm:px-0">
                                <br>
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Les information de l'announce </h3>
                            <p class="mt-1 text-sm text-gray-600">Votre annonce ne sera pas publiée tant que l'administrateur n'aura pas validé votre demande.</p>
                            </div>
                        </div>
                            ...
                            <form action="#" method="POST">
                                ...
                                <div class="bg-white px-4 py-5 sm:p-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="country" class="block text-sm font-medium text-gray-700">Prix</label>
                                        ...
                                        <option>Par heur</option>
                                        <option>Selon la periode</option>
                                        </select>
                                    </div>
                                ...
                                <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                                    <button type="submit" class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Publier</button>
                                </div>
                                </div>
                            </form>
                            </div>
