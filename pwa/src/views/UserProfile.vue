                    ...
                    <div class="text-gray-900 bg-white border border-gray-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                      ...
                      <div class="md:flex space-y-4 md:space-y-0 md:space-x-4">
                        <div class="flex-1">
                          ...
                          <input id="card-vat" class="form-input w-full cursor-not-allowed" type="text"  v-model="user.street" disabled/>
                        </div>
                        <div class="flex-1">
                          <label class="block text-sm font-medium mb-1" for="card-vat">City</label>
                          <input id="card-vat" class="form-input w-full cursor-not-allowed" type="text"  v-model="user.city" disabled/>
                        </div>
                        <div class="flex-1">
